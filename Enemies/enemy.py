...
class Enemy:
    def __init__(self):
        ...
        self.path = [(21, 460), (314, 462), (371, 447), (398, 403),
                     (407, 295), (430, 246), (478, 223), (522, 230),
                     (564, 247), (591, 287), (598, 338), (625, 371),
                     (666, 395), (718, 396), (770, 406), (802, 430),
                     (851, 458), (899, 469), (958, 470), (998, 471),
                     (1050, 471)]
        self.path_pos = 0
        self.direction = (0, 0)
    ...
    def animate(self):
        ...
        if self.current_mode == self.mode['run']:
            ...
            self.animation_count += self.timer // self.animation_speed
    ...
    def update(self, dt):
        ...
        self.animate()
        self.move()
        self.timer = self.timer % self.animation_speed